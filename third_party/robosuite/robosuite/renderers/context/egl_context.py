    ...
    def free(self):
        ...
        if self._context:
            try:
                ...
                # During shutdown, the EGL display may already be terminated
                # by the atexit handler, causing EGL_NOT_INITIALIZED errors.
                # We can safely ignore these errors during cleanup.
                pass
        self._context = None
